...
function App() {
  ...
  function openGuestsIsModal() {
    setIsGuestsModalOpen(true)
  }

  function closeGuestsIsModal() {
    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        <div className='flex flex-col items-center gap-3'>
          ...
          <p className="text-zinc-300 text-lg">Convide seus amigos para a próxima viagem!</p>
        </div>
        ...
        <div className='space-y-4'>
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              <button type='button' onClick={openGuestsIsModal} className='flex items-center gap-2 flex-1'>
        ...
        <p className="text-sm text-zinc-500">
          ...
          com nossos <a href="#" className="text-zinc-300 underline">termos de uso</a> e <a href="#" className="text-zinc-300 underlin">politicas de privacidade</a>
        </p>
      </div>
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            <div className='space-y-2'>
              <div className="flex items-center justify-between">
                ...
                <button type='button' onClick={closeGuestsIsModal}>
